import pytest
from routes.scope2.estimate import scope2_name_space  
...
def test_successful_post_request(client):
    ...
    response = client.post('/scope2/estimate', json=valid_payload)
...
def test_missing_field_request(client):
    ...
    response = client.post('/scope2/estimate', json=invalid_payload)
...
def test_emission_factor_not_found(client):
    ...
    response = client.post('/scope2/estimate', json=payload)
